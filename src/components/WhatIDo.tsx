        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <div className="what-content-flex">
                <div className="what-tags">Web apps</div>
                <div className="what-tags">Networks</div>
                <div className="what-tags">Cloud</div>
                <div className="what-tags">Exploit validation</div>
                <div className="what-tags">Risk reporting</div>
              </div>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h5>Capabilities</h5>
              <div className="what-content-flex">
                <div className="what-tags">SOC operations</div>
                <div className="what-tags">Incident response</div>
                <div className="what-tags">SIEM &amp; SOAR</div>
                <div className="what-tags">Vulnerability management</div>
                <div className="what-tags">Threat intel</div>
              </div>
              <div className="what-arrow"></div>
            </div>
          </div>
